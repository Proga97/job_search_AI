...
export interface AppSettings {
  ...
  hiddenCompanies: Resolved<string[]>;
  ...
  autoRefreshJobsEnabled: Resolved<boolean>;
  autoRefreshJobsIntervalMinutes: Resolved<number>;
  ...
  scoringRubric: Resolved<ScoringRubric>;
