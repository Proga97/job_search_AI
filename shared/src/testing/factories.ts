...
export const createAppSettings = (
  ...
  scoringRubric: {
    value: { skills: 30, experience: 25, location: 15, domain: 15, growth: 15 },
    default: {
      skills: 30,
      experience: 25,
      location: 15,
  ...
  autoRefreshJobsEnabled: { value: false, default: false, override: null },
  autoRefreshJobsIntervalMinutes: { value: 60, default: 60, override: null },
