...
# DEVELOPMENT STAGE
# ============================================================================
FROM build-sources AS development

# Keep local resume previews consistent with production while retaining the
# development dependencies and source layout used by Vite.
