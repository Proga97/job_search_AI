...
Apply Assistant is a small companion process that runs directly on your computer. Meow AI sends it the selected job link and the minimum contact details needed to fill common application fields. It opens a visible Chromium window, fills fields it recognizes, and stops for your review.
...
5. Review every populated field, answer any remaining questions, attach the correct resume, and submit manually.
...
The first version intentionally fills only low-risk identity and contact fields. It leaves work authorization, sponsorship, demographic, compensation, file-upload, and free-text questions untouched.
