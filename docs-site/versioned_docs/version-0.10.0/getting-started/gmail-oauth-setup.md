...
description: Step-by-step Google Cloud setup for Meow AI Gmail tracking, with exact scopes and callback configuration.
sidebar_position: 2
---

## What it is

This guide configures Google OAuth so Meow AI can read recruitment emails from Gmail for the Tracking Inbox.

## Why it exists

Gmail OAuth setup is easy to misconfigure (wrong redirect URI, missing refresh token, or unnecessary scopes). This page documents the exact defaults Meow AI expects.
...
- Meow AI does not require JavaScript origins for this flow.
...
### 3) Connect Gmail in Meow AI

1. Open **Tracking Inbox**.
2. Click **Connect Gmail**.
3. Complete Google consent.

Meow AI starts OAuth with:
...
Not required for Meow AI Gmail ingestion:
