...
2. **Import your current resume**: Either upload a PDF/DOCX into Meow AI or choose the Reactive Resume option and connect with your v5 API key.
3. **Search terms**: Meow AI generates a first list of job-title search terms from your selected resume. Edit or regenerate them before saving.
...
Meow AI supports 2 PDF renderers:
