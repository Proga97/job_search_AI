...
When enabled for a job, Meow AI rewrites eligible outbound RxResume links to your Meow AI host, then redirects to the original destination after recording a click event.
...
Meow AI uses this URL when request host inference is not available.
