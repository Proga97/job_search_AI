...
- If language detection is unclear or there is not enough resume/profile text, Meow AI falls back to English
...
- If Meow AI cannot determine a reliable resume/profile language, it safely uses English.
