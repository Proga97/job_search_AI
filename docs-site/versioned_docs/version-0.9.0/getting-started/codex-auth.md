...
description: Authenticate Codex in Meow AI with the built-in device-code sign-in flow.
sidebar_position: 3
---

## What it is

This page explains how to authenticate the `codex` provider in Meow AI.

Use the device-code sign-in flow from the Meow AI UI.
...
### Device-code sign-in in Meow AI

1. In Meow AI, set **Provider** to `Codex` in onboarding or settings.
