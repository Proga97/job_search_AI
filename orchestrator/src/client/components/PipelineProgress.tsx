...
const stepBadgeClasses: Record<PipelineProgressState["step"], string> = {
  ...
  crawling:
    "border-sky-500/35 bg-sky-100/90 text-sky-900 dark:bg-sky-400/15 dark:text-sky-100",
  challenge_required:
    "border-orange-500/35 bg-orange-100/90 text-orange-900 dark:bg-orange-400/15 dark:text-orange-100",
  importing:
    "border-sky-500/35 bg-sky-100/90 text-sky-900 dark:bg-sky-400/15 dark:text-sky-100",
  scoring:
    "border-amber-500/35 bg-amber-100/90 text-amber-900 dark:bg-amber-400/15 dark:text-amber-100",
  processing: "bg-primary/10 text-primary border-primary/20",
  completed:
    "border-emerald-500/35 bg-emerald-100/90 text-emerald-900 dark:bg-emerald-400/15 dark:text-emerald-100",
