...
export const getSuitabilityScoreTokens = (
	score: number | null,
	isAwaitingAi = false,
) => {
		...
		return (
			...
			>
				...
				>
					...
					/>
					<div className="relative z-10 flex h-full w-full flex-col items-center justify-center rounded-full border border-current/15 bg-card text-center">
						<div
							className={cn(
	...
	return (
		<Popover open={popoverOpen} onOpenChange={handlePopoverOpenChange}>
			...
			<PopoverContent
				side="bottom"
				align="end"
				className="z-[100] w-96 rounded-xl border border-border bg-card p-4 text-card-foreground shadow-md"
			>
