...
export type SponsorFilterValue =
	| "available"
	| "unavailable"
	| "sponsor_listed"
	| "unknown";
export type SponsorFilter = SponsorFilterValue[];
...
export const experienceLevelValues = experienceLevelOptions.map(
	(option) => option.value,
);
...
export const scoreThresholdOptions = [50, 60, 70, 80, 90] as const;
