...
export type DisplayValues = {
  ...
  autoRefreshJobsEnabled: EffectiveDefault<boolean>;
  autoRefreshJobsIntervalMinutes: EffectiveDefault<number>;
  hiddenCompanies: EffectiveDefault<string[]>;
};
...
export type ScoringValues = {
  scoringRubric: EffectiveDefault<ScoringRubric>;
