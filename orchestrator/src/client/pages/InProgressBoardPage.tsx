              ...
              {BOARD_STAGES.map((stage) => {
                ...
                return (
                  <section
                    ...
                    className={cn(
                      "flex h-full w-[320px] flex-col rounded-xl border border-border/70 bg-background/85 shadow-[0_10px_24px_-20px_rgba(0,0,0,0.8)] transition-colors dark:bg-card/80",
